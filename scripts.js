	...
	var Engine = {
		...
		ui : {
			...
			tooltips : function(){
				...
				$('#featured-chris img').tooltip($.extend({},defaults,{ offset : [-3 , 12] }));
				$('#featured-russ img').tooltip($.extend({},defaults,{ offset : [-3 , -3] }));
				$('#featured-shatha img').tooltip($.extend({},defaults,{ offset : [-3 , 0] }));
				...
				$('#featured-mike img').tooltip($.extend({},defaults,{ offset : [-3 , -7] }));
				$('#featured-ema img').tooltip($.extend({},defaults,{ offset : [-3 , 6] }));
